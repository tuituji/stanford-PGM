...
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, assignment, alphaList);
assignment = [2,1; 2,2; 2,3];
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, assignment, 1- alphaList);
